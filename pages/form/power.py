...
tab1, tab2 = st.tabs(["قدرت", "استقامت"])
        ...
        for i in range(st.session_state.num_rows):
            ...
            with st.container(border=True):
                ...
                if max_reps > 0:
                    ...
                    df_sorted = df.sort_values(by='% of 1RM', ascending=False)
                    ...
                    chart_data = pd.DataFrame(
                        {
                            "Weight": df_sorted['Weight'],
                            "% of 1RM": df_sorted['% of 1RM'],
                            # "col3": ["A"] * 20 + ["B"] * 20 + ["C"] * 20,
                        }
                    )
                    print(df_sorted['Weight'])
                    print(df_sorted['% of 1RM'])
